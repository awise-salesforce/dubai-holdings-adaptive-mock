...
const SearchBar = ({ show, onInitialMessage }) => {
  ...
  const handleSearch = (e) => {
    ...
    e.preventDefault();
    const form = e.target;
    const buttonVal = (_a = form.elements.namedItem("buttonText")) == null ? void 0 : _a.value;
